...
//   setWalletInfo,
//   setWeb3Provider,
// } from "@/redux/walletService/wallet.service";
import ConnectButton from "../button/buttonConnectWallet";
...
export default function AppHeader() {
  ...
  //     const bigBalance = await provider.getBalance(address); // ether 6
  //     const ethBalance = Number.parseFloat(ethers.formatEther(bigBalance)); //ether 6

  //     dispatch(setWalletInfo({ address, SepoliaETH: ethBalance }));
